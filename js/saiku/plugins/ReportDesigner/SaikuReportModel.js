...
reportDesigner.RootBandFormat = RootBandFormat;
...
reportDesigner.ElementFormat = ElementFormat;
...
reportDesigner.FieldDefinition = FieldDefinition;
...
reportDesigner.GroupDefinition = GroupDefinition;
...
reportDesigner.Parameter = Parameter;
...
reportDesigner.Datasource = Datasource;
...
(ReportSpecification = function (config) {
    ...
    addParameter: function (parameter) {
        var array = this.hasOwnProperty("parameters") ? this["parameters"] : this["parameters"] = [];
        array.push(parameter);
    },

    getParameterByName: function (name) {
        for (var i = 0; i < this.parameters.length; i++) {
            if(name==this.parameters[i].name) return this.parameters[i];
        }
    },
...
reportDesigner.ReportSpecification = ReportSpecification;
