...
var FilterDialog = Modal.extend({
    ...
    _filterNew: function () {
        ...
        this.columnMeta = this.workspace.query.selectedModel.getColumnById(columnInfo[1], columnInfo[3]);
        this.workspace.filterModel.addFilter(this.columnMeta, this.index);
        this._filterEdit();
        return;
    },
